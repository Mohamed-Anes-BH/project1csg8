    ...
    const renderStepContent = () => {
        switch (currentStep) {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full bg-zinc-800/50 border ${errors.lieu ? 'border-red-500' : 'border-zinc-700'} rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-[#F9B134] transition-colors`}
                                />
            ...
            case 4:
                return (
                    <div className="space-y-6">
                        <h3 className="text-lg font-semibold">Étape 4: Description de l'offre</h3>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleInputChange}
                                placeholder="Décrivez les missions, responsabilités, et le profil recherché..."
                                rows={6}
